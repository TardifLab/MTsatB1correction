...
b1rms = 9; %b1rms of one of the applied MT pulse in microTesla -> USER DEFINED
fitValue_fn = '/directory/fitvalues.m'; % location and name of fitValues file to be saved -> USER DEFINED
MTsatValue_fn = '/directory/MTsatvalues.m'; %save the computationally expensive results, incase fit needs to be adjusted -> USER DEFINED
